...
export class PhotosFacade {
  ...
  public photos = this.store.selectSignal(
    photosFeature.selectAllPhotos
  );
  ...
  public totalphotos = this.store.selectSignal(
  ...
  public albumPhotos = (albumId: Photo['albumId']) => this.store.selectSignal(
    photosFeature.selectAlbumPhotos(albumId)
  );
}
